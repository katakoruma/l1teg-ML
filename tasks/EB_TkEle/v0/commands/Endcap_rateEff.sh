...
run_analysis.py --cfg cfg/l1teg_cfg_endcap.py --mc data/TrainTest_samples.py  --flow flows/Endcap/TkEle/FlowBDT_test.py,bdt_path=\"/eos/user/l/lekerner/www/l1teg/Endcap/PU200_train/results/\",dir="float"  --plots plots/Endcap/TkEle/PlotTkEleFeatures.py:score_only=True -o $DIR --eras $ERA --noStack --snapshot --columnSel "TkEle_score,TkEle_(GenEle|CryClu)_pt,TkEle_GenEle_eta,TkEle_(Tk|GenEle)_idx,weight"