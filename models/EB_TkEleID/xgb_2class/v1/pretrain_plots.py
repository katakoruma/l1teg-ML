...
from params_pu200 import features, auxiliary, samples, tag, P0, path
import pandas as pd
import numpy as np
...
feat_info = {
    ...
    "TkEle_CryClu_hoe": (r"Cluster H/E", np.linspace(0,1,30)),
    ...
    "TkEle_CryClu_first5layers": (r"Cluster first5layers", np.linspace(0,30,30)),
    "TkEle_CryClu_firstHcal1layers": (r"Cluster firstHcal1layers", np.linspace(0,30,30)),
    "TkEle_CryClu_firstHcal3layers": (r"Cluster firstHcal3layers", np.linspace(0,30,30)),
    "TkEle_CryClu_firstHcal5layers": (r"Cluster firstHcal5layers", np.linspace(0,30,30)),
}
